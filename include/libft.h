...
/*   Updated: 2023/05/23 14:49:39 by nrossel          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char		*ft_strdup(const char *s1, t_list **trash);
...
char		*ft_strmapi(char *s, char (*f)(unsigned int, char), t_list **trash);
...
t_list		*ft_lstnew(void *data, t_list **trash_lst);
